    ...
    mx-auto mt-24">
        ...
        <form method="POST" action="/users">
            ...
            <div class="mb-6">
                ...
                @error('name')
                <p class="text-red-500 text-s mt-1">{{$message}}</p-text-red-500>
                @enderror
            </div>
            
            <div class="mb-6">
                <label for="email" class="inline-block
                text-lg mb-2"> Email:</label>
            ...
            <div class="mb-6">
                ...
                text-lg mb-2"> Confirm Password:</label>
                <input type="password" class="border
                border-gray-250 rounded p-2 w-full"
